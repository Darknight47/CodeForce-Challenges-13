...
--------------------------- Link for the challenge: https://codeforces.com/problemset/problem/2114/A -------------------------------------

One can notice the following remarkable mathematical fact: the number 2025 can be represented as (20+25)^2.

You are given a year represented by a string s, consisting of exactly 4 characters. Thus, leading zeros are allowed in the year representation. 
For example, "0001", "0185", "1375" are valid year representations. 
...
Two numbers a and b (a,b ≥ 0) such that (a+b)^2 = s, if they exist. If there are multiple suitable pairs, you may output any of them.The number −1 otherwise.
